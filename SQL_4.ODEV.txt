...
CEVAP:SELECT COUNT (title) FROM film WHERE title LIKE 'T%' AND rating='G';

SORU4-country tablosunda bulunan ülke isimlerinden (country) kaç tanesi 5 karakterden oluşmaktadır?

CEVAP:SELECT COUNT (country) FROM country WHERE country LIKE '_____';

SORU5-city tablosundaki şehir isimlerinin kaç tanesi 'R' veya r karakteri ile biter?

CEVAP:SELECT COUNT(city) FROM city WHERE city ILIKE '%r';
